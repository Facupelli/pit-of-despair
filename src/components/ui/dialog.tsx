		...
		<DialogPortal>
			...
			<DialogPrimitive.Content
				...
				className={cn(
					...
					"bg-card text-card-foreground font-mono",
					"shadow-[0_0_20px_var(--glow-primary)]",
					"p-6 duration-200 rounded-none",
					"data-[state=open]:animate-in data-[state=closed]:animate-out",
					"data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
			...
			>
				...
				{showCloseButton && (
					<DialogPrimitive.Close
						...
						className={cn(
							"absolute top-2 right-2 p-0.5 text-muted-foreground",
	...
	return (
		<DialogPrimitive.Title
			...
			className={cn(
				...
				"text-primary [text-shadow:0_0_8px_var(--glow-primary)]",
				className,
			)}
			{...props}
		/>
